...
{
    public class ServiceService : EFService<Service, ServiceRequestModel, ServiceResponseModel>, IServiceService
    {

        public ServiceService(IServiceRepository repository, IServiceMapper mapper) : base(repository, mapper)
        {
        }
    }
}
